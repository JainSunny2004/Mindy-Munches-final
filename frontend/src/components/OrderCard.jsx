    ...
    >
      ...
      <div className="p-4 border-b border-neutral-100">
        <div className="flex justify-between items-start mb-3">
          <div>
            <h3 className="font-semibold text-neutral-800">Order #{order.orderNumber}</h3>
          ...
          >
            <div className="p-4 space-y-4">
              ...
              <div className="border-t border-neutral-100 pt-3">
                <h4 className="font-medium text-neutral-800 mb-3">Price Details</h4>
              ...
              {/* Shipping Address */}
              <div className="border-t border-neutral-100 pt-3">
                <h4 className="font-medium text-neutral-800 mb-2">Shipping Address</h4>
                <div className="text-sm text-neutral-600">
              ...
              <div className="border-t border-neutral-100 pt-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-neutral-600">{getDeliveryStatus(order)}</p>
